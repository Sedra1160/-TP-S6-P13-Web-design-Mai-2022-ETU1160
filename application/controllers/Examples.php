...
class Examples extends CI_Controller {
	...
	public function _example_output($output = null)
	{
		...
		$this->load->view('templateAdmin.php',(array)$output);
	}
	...
	public function contenue_management(){
		$crud = new grocery_CRUD();
			...
			$crud->callback_before_insert(array($this,'slugifyContenue'));
			$crud->callback_before_update(array($this,'slugifyContenue'));

			$output = $crud->render();

			$this->_example_output($output);
	}
	public function slugifyContenue($array) 
        {
            $divider = '-';
	...
	public function employees_management()
	{
			...
			$crud->set_theme('flexigrid');
			$crud->set_table('superuser');
			$crud->set_subject('Superuser');
	...
	public function slugify($array) 
		...
		public function utilisateur_management()
	{
			$crud = new grocery_CRUD();

			$crud->set_theme('flexigrid');
			$crud->set_table('simpleuser');
			$crud->set_subject('Simpleuser');
