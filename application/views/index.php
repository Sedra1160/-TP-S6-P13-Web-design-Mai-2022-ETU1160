                ...
                <div class="container my-5 py-5">
                    <div class="row align-items-center g-5">
                        <div class="col-lg-6 text-center text-lg-start">
                            <h1 class="display-3 text-white animated slideInLeft">Stop<br> au chahgement climatique</h1>
                            <p class="text-white animated slideInLeft mb-4 pb-2">Le principal facteur du réchauffement est les émissions de gaz à effet de serre dues aux activités humaines</p>
            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-6">
                        ...
                        <p class="mb-4">La sensibilisation des enfants à l’environnement va les imprégner et aura un réel impact dans le futur. Les enfants sont les meilleurs porteurs de toutes les mobilisations l’exemple de Greta Thunberg en dit beaucoup. </p>
